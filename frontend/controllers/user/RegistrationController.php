    ...
    public function actionConfirm($id, $code)
    {
        ...
        if ($this->make(AccountConfirmationService::class, [$code, $user, $userConfirmationService])->run()) {
            ...
            if($business){
                ...
                Yii::$app->formatter->decimalSeparator = $business->decimal_separator;
                Yii::$app->formatter->thousandSeparator = $business->thousands_separator;
                Yii::$app->formatter->defaultTimeZone = $business->timezone;
                Yii::$app->formatter->locale = $business->locale;
                Yii::$app->formatter->currencyCode = $business->currency_code;
                Yii::$app->formatter->currencyDecimalSeparator = $business->decimal_separator;
            }
