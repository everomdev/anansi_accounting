            ...
            <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s">
                <div class="about-item overflow-hidden">
                    ...
                    <p class="fs-5" style="text-align: justify;">
                        Con nuestro Sistema de Costeo para Restaurantes, podrás tomar decisiones informadas, reducir gastos innecesarios y aumentar tus ganancias. Nuestra plataforma te brinda la tranquilidad de saber que estás tomando las mejores decisiones para tu negocio.
                    </p>
