...
return [
    ...
    'Class' => '',
    'Close' => '',
    'Code for two factor authentication on {0}' => 'Código para autenticación de dos factores en {0}',
    ...
    'In order to complete your verification, use the following verification code' => '',
    ...
    'This is the code to insert to enable two factor authentication' => 'Este es el código para insertar y habilitar la autenticación de dos factores',
    ...
    'Your account on {0} has been verified' => '',
