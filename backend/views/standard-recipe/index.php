...
<div class="standard-recipe-index">
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Descargar PDF'), \yii\helpers\Url::to(['standard-recipe/download-recipes-pdf']), ['class' => 'btn btn-success', 'id' => 'btn-download-recipes']) ?>
        <?= Html::a(Yii::t('app', 'Descargar Excel'), \yii\helpers\Url::to(['standard-recipe/download-recipes']), ['class' => 'btn btn-success', 'id' => 'btn-download-recipes']) ?>
    </p>
