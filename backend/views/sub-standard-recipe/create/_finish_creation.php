...
<div class="card">
    <?php $form = \yii\bootstrap5\ActiveForm::begin([
        'action' => \yii\helpers\Url::to(['sub-standard-recipe/finish-recipe-creation', 'id' => $model->id]),
    ...
    <div class="card-footer">
        <?= \yii\bootstrap5\Html::a(Yii::t('app', 'Back'), \yii\helpers\Url::to(['sub-standard-recipe/select-ingredients', 'id' => $model->id]), [
